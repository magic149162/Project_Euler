...
#solution 1: almost brute force,though utilise a combination of hand deduction and code computation. It's worth noticing that the number of 
#permutations is equal to the factorial of usable digits.So we guess that the result should start with 27, then we calculate all of the
